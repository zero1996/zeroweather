...
//	public static final String CREATE_COUNTY = "create table COUNTY (id integer primary key autoincrement,county_name text,county_code text,city_id integer)";
	public static final String CREATE_CITY_DETAIL = "create table CityDetail (id integer primary key autoincrement,country text,province text,city text,code text)";
